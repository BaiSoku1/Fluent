--[[ 
    PREMIUM MODERN SILVER UI (V11) - URL LOADER VERSION
    - Style: Compact & Refined
    - Features: Can be loaded via URL, custom window title with letter-by-letter display
...
local function CreateAnimatedTitle(parent, titleText, position, size)
    local TweenService = game:GetService("TweenService")
...
function Library:CreateWindow(config)
    ...
    local titleContainer, letterLabels = CreateAnimatedTitle(TopBar, titleText, UDim2.fromOffset(12, 0), UDim2.new(1, -60, 1, 0))
